...
BOARD_SUPER_PARTITION_GROUPS := blair_dynamic_partitions
BOARD_BLAIR_DYNAMIC_PARTITIONS_SIZE := 9122611200 # BOARD_SUPER_PARTITION_SIZE - 4M
BOARD_BLAIR_DYNAMIC_PARTITIONS_PARTITION_LIST := \
    odm \
    product \
    system \
    system_ext \
...
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 33554432
endif
BOARD_ODMIMAGE_PARTITION_RESERVED_SIZE := 33554432
BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 33554432
